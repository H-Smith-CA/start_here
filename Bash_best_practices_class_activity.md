...
>
>#Output:
>anaconda	Documents	Movies		Public
...
>ls -l
>total 16
>drwxr-xr-x   23 haleymo  staff   736 Sep  9 18:10 >anaconda
>drwx------    4 haleymo  staff   128 May 14  2015 >Applications
>drwx------@  53 haleymo  staff  1696 Sep  9 18:02 >Desktop
>drwx------+  29 haleymo  staff   928 Sep  9 17:35 >Documents
>drwx------+  53 haleymo  staff  1696 Jan 10  2023 >Downloads
>drwx------@ 107 haleymo  staff  3424 Jul 11 19:35 >Library
>drwx------+   6 haleymo  staff   192 Dec  5  2020 >Movies
>drwx------+   7 haleymo  staff   224 Dec  1  2020 >Music
>drwx------+   8 haleymo  staff   256 Apr  7  2021 >Pictures
>drwxr-xr-x    5 haleymo  staff   160 May 14  2015 >Public
>drwxr-xr-x+   3 haleymo  staff    96 Dec  1  2020 >Sites
>-rw-r--r--    1 haleymo  staff  6217 Dec  2  2016 >Untitled.ipynb
>#Output
>
>
>```
...
><br>
><br>Using -p makes all the files in the path. Without the -p it trys to make it all as a single file
...
> ```
>bash-3.2$ pwd
>/Users/haleymo/Documents/GitHub/btec_640
>bash-3.2$ mkdir genomics_project
>bash-3.2$ pwd
>/Users/haleymo/Documents/GitHub/btec_640
>bash-3.2$ ls
>class_exercises		genomics_project
>bash-3.2$ mkdir transcriptomics_project
>bash-3.2$ ls
>class_exercises		genomics_project transcriptomics_project
>bash-3.2$ cd genomics_project/
>bash-3.2$ mkdir input_data final_output analysis src
>bash-3.2$ ls
>analysis	final_output	input_data	src
>bash-3.2$ cd ../
>bash-3.2$ cd transcriptomics_project/
>bash-3.2$ mkdir input_data final_output analysis src
>bash-3.2$ ls
>analysis	final_output	input_data	src
>bash-3.2$ 
